...
resfinder_folder <- paste(snakemake@config[["project_dir"]],"/output_data/","/",snakemake@config[["project"]],"/abricate/resfinder/", sep = "")
plasmidfinder_folder <- paste(snakemake@config[["project_dir"]],"/output_data/","/",snakemake@config[["project"]],"/abricate/plasmidfinder/", sep = "")
